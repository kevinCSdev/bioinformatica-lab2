function inicializar(algoritmo) {
    ...
    if (algoritmo == "ed") {
        edges = inicializacionED(edges, seq1, seq2, gap);
        // Sanitizar: asegurar que las celdas interiores no muestren valores ni flechas
        // hasta que el usuario avance paso a paso. Solo conservar primera fila/col.
        edges.forEach(e => {
            if (e.i > 0 && e.j > 0) {
                e.puntaje = undefined;
                e.max = undefined;
                e.diagonal = 0; e.superior = 0; e.lateral = 0;
