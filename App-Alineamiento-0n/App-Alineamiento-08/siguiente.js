function siguiente(algoritmo,p) {
    ...
    // Obtener los caracteres correctos de las secuencias basándose en las coordenadas de la matriz
    let s1 = (coordenadas[0] > 0) ? seq1[coordenadas[0] - 1] : '';
    let s2 = (coordenadas[1] > 0) ? seq2[coordenadas[1] - 1] : '';
